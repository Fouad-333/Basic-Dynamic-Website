...
function validate() /**To validate the enquire form data fields.*/
{
   ...
   if(result)
   {
	   saveEnquireFormInformation (firstName, lastName, emailAdrress, phoneNumber, postCode, Price, memberShipDuration, stateInfo, Product, fullName);
   }
...
function saveEnquireFormInformation (firstName, lastName, emailAdrress, phoneNumber, postCode, Price, memberShipDuration, stateInfo, Product, fullName) /**To save the enquire form data on browser storage..*/
{
